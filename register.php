...
if (isset($_POST['StudentRegistration'])) {
    if (isset($_POST['StudentName']) && $_POST['StudentName'] != "" && isset($_POST['StudentEmail']) && $_POST['StudentEmail'] != "" && isset($_POST['StudentContactNo']) && $_POST['StudentContactNo'] != "" && isset($_POST['StudentDob']) && $_POST['StudentDob'] != "" && isset($_POST['StudentId']) && $_POST['StudentId'] != "" && isset($_POST['StudentYear']) && $_POST['StudentYear'] != "" && isset($_POST['StudentBranch']) && $_POST['StudentBranch'] != "" && isset($_POST['StudentSection']) && $_POST['StudentSection'] != "" && isset($_POST['StudentPassword']) && $_POST['StudentPassword'] != "" && isset($_POST['StudentConfirmPassword']) && $_POST['StudentConfirmPassword'] != "" ) {
        ...
        if (mysqli_num_rows($StudentCheckSql) > 0) {
            ...
            $StudentContactNo = $connect -> real_escape_string($_POST['StudentContactNo']);
            ...
            // Allow +, - and . in phone number
            $filtered_phone_number = filter_var($StudentContactNo, FILTER_SANITIZE_NUMBER_INT);
            // Remove "-" from number
            $phone_to_check = str_replace("-", "", $filtered_phone_number);
            if ($StudentPassword != $StudentConfirmPassword) {
                ...
                $StudentRegisterQuery = "INSERT INTO `students`(`name`, `id`, `email`, `contactNo`, `dob`, `year`, `branch`, `section`, `password`) VALUES ('$StudentName','$StudentId','$StudentEmail','$StudentContactNo','$StudentDob','$StudentYear','$StudentBranch','$StudentSection','$hashed_password')";
                                        ...
                                        <div class="col-sm-6">
                                            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="md-5">
                                                ...
                                                <div class="mb-3 ">
                                                    ...
                                                    <input type="tel" name="StudentContactNo" class="form-control border-primary shadow-none" id="StudentContactNo required/> 
                                                </div>
                                                <div class="mb-3">
